      ...
      for (int h = 0; h < output_height; h++) {
        for (int w = 0; w < output_width; w++) {
          ...
          startindex = (b * num_channels * input_height * input_width)
                     + (h * stride_height * input_width * num_channels)
                     + (w * stride_width * num_channels) + c;
          ...
          for (int i = 0; i < pool_height; i++) {
            for (int j = 0; j < pool_width; j++) {
              poolindex = i * input_width * num_channels + j * num_channels;
          ...
          outputindex = (h * output_width * num_channels)
                      + (w * num_channels) + c;
