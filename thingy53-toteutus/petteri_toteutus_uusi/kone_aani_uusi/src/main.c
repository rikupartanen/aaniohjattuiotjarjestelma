 ...
 * Petteri Karjalainen
 * Yritysprojekti 3 2024 Iot ääniohjaus Thredilla.
 */
...
double audio_data = 0.0; //Output data for print

int din_pin_out = 27, clk_pin_out = 25;
...
void setup_pdm_audio()
{
	...
	uint8_t gain_setup_left_right = 20000; //Gain setting for pdm
