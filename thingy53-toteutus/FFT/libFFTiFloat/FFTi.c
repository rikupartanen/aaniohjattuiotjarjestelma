...
void FFT(complex float *window, int arraySize){
  ...
  for(int i = 1; i < arraySize; i++){
     ...
     if(i > bitrev){   //ensure that it doesn't dublicate
        complex float temp = window[i];  //then swap numbers
...
float windows[numberOfWindows][window_size]; //should be 124 windows, and 256 values in each window array, it holds the windowed data
